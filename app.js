        ...
        vision.labelDetection(messageAttachments[0].payload.url)
            .then(function(res) {
                sendTextMessage(senderID, "Thanks for sending in your food photo!")
                    ...
                    .then(() => sendTextMessage(senderID, "Please correct us if we're wrong! Cheers."))
                    .then(() => sendTypingOff(senderID));
            })
            .catch(function(err) {
                sendTextMessage(senderID, "Sorry we could not process your image. Please let us know what's in your picture!");
                sendTypingOff(senderID);
            });
    } else {
...
function sendHiMessage(recipientId) {
  var messageData = {
    ...
    message: {
      text: "Hey there! I'm Kenko Bot. I'm here to help you track your food! Please send a picture of what you're eating :)"
    }
  }
