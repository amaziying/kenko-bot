...
CREATE TABLE `users` (
  ...
  `ss_lower_grain` int(11) NOT NULL,
  `ss_higher_grain` int(11) NOT NULL,
  `ss_lower_meatalt` int(11) NOT NULL,
  `ss_higher_meatalt` int(11) NOT NULL,
  `ss_lower_milkalt` int(11) NOT NULL,
  `ss_higher_milkalt` int(11) NOT NULL,
  `ss_lower_veg` int(11) NOT NULL,
  `ss_higher_veg` int(11) NOT NULL,
  `ss_lower_fru` int(11) NOT NULL,
  `ss_higher_fru` int(11) NOT NULL,
  PRIMARY KEY (`user_id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
